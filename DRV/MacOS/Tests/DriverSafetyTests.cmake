...
foreach(required_control_center_view IN ITEMS
        ...
        "uartCaptureInProgress"
        "startUARTCapture"
        "Live Time Card topology"
        "TimeCardTopologyDiagramView"
        "macOS service"
        "DriverKit"
        "PHC"
        "FPGA cores"
        "FPGA core readiness matrix"
        "FPGACoreReadinessMatrixView"
        "TimeCardFPGACoreReadiness"
        "PPS master/slave"
        "IRIG-B decoder"
        "DCF77 decoder"
        "NMEA generator"
        ...
        "ReceiverValidationChecklist"
        "MON-VER identity"
        "NAV-TIMELS UTC/leap"
        "TIM-TP time pulse"
        "RTCM3 correction health"
        "receiver-validation.txt"
        "Windows-style LED policy presets"
        "LEDPolicyPresetGrid"
        "LEDPolicyPresetCard"
        "GNSS health"
        "SMA direction"
        "Full front panel"
        "Apply All LED Policy"
        "Board variant compatibility"
        "BoardVariantCompatibilityView"
        "TimeCardBoardVariantCompatibility"
        "Meta/Facebook Time Card"
        "Celestica R4006"
        "Orolia/Safran ART"
        "ADVA Time Card X1"
